...
public class CardItemDecorator extends ItemDecoration {
   ...
   public CardItemDecorator(Resources var1, Provider var2, LayoutManager var3, boolean var4) {
      ...
      this.viewComparator = new Comparator<View>() {
         public int compare(View var1, View var2) {
            return var1.equals(var2)?0:var1.getTop() - var2.getTop();
         }
      };
      if(var2 != null) {
         this.mProvider = var2;
         this.mManager = var3;
         float var5 = (float) V.dp(2.0F);
         this.fullWidth = var4;
         this.mDrawable = new CardDrawable(var1, -1, var5, var4);
   ...
   private void drawBackground(Canvas var1, Rect var2, int var3, int var4) {
      ...
      if(this.tmpRect.left > 0) {
         ...
         var1.drawRect((float)(var2.left + this.tmpRect.left), (float)(var2.top + this.tmpRect.top - Math.min(0, var3)), (float)(var2.left + this.tmpRect.left + V.dp(2.0F)), (float)(var2.top + this.tmpRect.top - Math.min(0, var3) + V.dp(2.0F)), this.bgPaint);
         var1.drawRect((float)(var2.left + this.tmpRect.left), (float)(var2.bottom - this.tmpRect.bottom - V.dp(2.0F)), (float)(var2.left + this.tmpRect.left + V.dp(2.0F)), (float)(var2.bottom - this.tmpRect.bottom), this.bgPaint);
      }
      ...
      if(this.tmpRect.right > 0) {
         ...
         var1.drawRect((float)(var2.right - this.tmpRect.right - V.dp(2.0F)), (float)(var2.top + this.tmpRect.top - Math.min(0, var3)), (float)(var2.right - this.tmpRect.right), (float)(var2.top + this.tmpRect.top - Math.min(0, var3) + V.dp(2.0F)), this.bgPaint);
         var1.drawRect((float)(var2.right - this.tmpRect.right - V.dp(2.0F)), (float)(var2.bottom - this.tmpRect.bottom - V.dp(2.0F)), (float)(var2.right - this.tmpRect.right), (float)(var2.bottom - this.tmpRect.bottom), this.bgPaint);
      }
   ...
   public void getItemOffsets(Rect var1, View var2, RecyclerView var3, State var4) {
      ...
      if(var8 >= var3.getAdapter().getItemCount()) {
         ...
         label71: {
            ...
            var7 = this.mProvider.getBlockType(var8);
         ...
         if(var8 < 0) {
            ...
            if((var6 & 6) == 6) {
               ...
               label200: {
                  ...
                  var11 = this.getViewBottom(var16) + V.dp(2.0F);
                  var5 = var12;
                  var4 = var7;
                  var8 = var6;
                  if(var11 >= var12) {
               ...
               if((var6 & 1) == 1) {
                  label202: {
                     ...
                     if(var7 == Integer.MIN_VALUE) {
                        var9 = this.getViewTop(var16) - V.dp(5.0F);
                     }
                     ...
                     var19 = this.getViewBottom(var16) + V.dp(2.0F);
                     var5 = var12;
                     var4 = var9;
                     var8 = var11;
                     if(var19 >= var12) {
   ...
   public void setInnerMargins(int var1, int var2, int var3, int var4) {
      this.marginLeft = var1;
      this.marginRight = var3;
      this.marginTop = var2;
      this.marginBottom = var4;
   }

   public void setPadding(int var1, int var2, int var3, int var4) {
      this.paddingBefore = var1;
      this.paddingAfter = var2;
      this.paddingFirst = var3;
      this.paddingLast = var4;
   }
