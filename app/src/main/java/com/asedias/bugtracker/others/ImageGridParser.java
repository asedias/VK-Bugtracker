...
import com.asedias.bugtracker.model.reportview.Photo;
...
public class ImageGridParser {
    ...
    public ImageGridParser(Activity activity, List<Photo> photos, ViewGroup root) {
    ...
    public ImageGridParser(Activity activity, List<Photo> photos, ViewGroup root, int rootLayoutWidth) {
        this.activity = activity;
        this.photos = photos;
        this.root = root;
        this.layout = new FlowLayout(BugTrackerApp.context);
    ...
    private void parse() {
        ...
        //if(sizes.size() > 0) this.root.addView(layout, new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, sizes.get(0).heigth));
    }

    private ArrayList<PhotoSize> getLayoutParams(int count, List<Photo> list) {
        ArrayList<PhotoSize> sizes = new ArrayList<PhotoSize>();
        float k = 0;
        float h;
        float width0;
        float width1;
    ...
    private class PhotoSize {
        ...
        public PhotoSize(int heigth, int width) {
            this.heigth = heigth;
            this.width = width;
        }

        public PhotoSize(int heigth, int width, boolean breakAfter) {
            this.heigth = heigth;
            this.width = width;
